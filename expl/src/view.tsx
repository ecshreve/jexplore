...
// region Boolean
export const JeppBooleanViewOnShow: React.FC<ViewProps<Type.JeppBoolean>> = ({value}) => {
...
// region String
export const JeppStringViewOnShow: React.FC<ViewProps<Type.JeppString>> = ({value}) => {
    return <Antd.Typography.Text copyable={true}>{ value }</Antd.Typography.Text>
}
export const JeppStringViewOnList: React.FC<ViewProps<Type.JeppString>> = ({value}) => {
...
// region Number
export const JeppNumberViewOnShow: React.FC<ViewProps<Type.JeppNumber>> = ({value, ...props}) => {
    return <JeppStringViewOnShow value={String(value)} {...props} />
}
export const JeppNumberViewOnList: React.FC<ViewProps<Type.JeppNumber>> = ({value, ...props}) => {
...
// region String List
export const JeppStringListViewOnShow: React.FC<ViewProps<Type.JeppStringList>> = ({value}) => {
    return <>{ value?.map( (v, i) => <JeppStringViewOnShow key={i} value={ String(i+1) + '. ' + v}/> ) }</>;
}
export const JeppStringListViewOnList: React.FC<ViewProps<Type.JeppStringList>> = ({value}) => {
...
// region Image
export const JeppImageViewOnShow: React.FC<ViewProps<Type.JeppImage>> = ({value}) => {
    return <Antd.Image style={ {width: '100%', maxWidth: '256px' } } src={value}/>
}
export const JeppImageViewOnList: React.FC<ViewProps<Type.JeppImage>> = ({value}) => {
...
// region UUID
export const JeppUUIDViewOnShow: React.FC<ViewProps<Type.JeppUUID>> = JeppStringViewOnShow
export const JeppUUIDViewOnList: React.FC<ViewProps<Type.JeppUUID>> = JeppStringViewOnList
export const JeppUUIDViewOnForm: React.FC = JeppStringListViewOnForm
// endregion UUID

// region Code
export const JeppCodeViewOnForm: React.FC<TextareaCodeEditorProps> = (props) => {
    return <CodeEditor
        {...props}
        padding={15}
        style={ {
...
export const JeppCodeViewOnShow: React.FC<ViewProps<Type.JeppCode>> = ({value}) => {
    return <JeppCodeViewOnForm value={value} readOnly={true}/>
}
export const JeppCodeViewOnList: React.FC<ViewProps<Type.JeppCode>> = ({value}) => {
    return <RA.TextField value={value} code={true} ellipsis={true} style={ {width: '100px'} }/>
}
// endregion Code

// region Rich Text
export const JeppRichTextViewOnShow: React.FC<ViewProps<Type.JeppRichText>> = ({value})=>{
    return <div dangerouslySetInnerHTML={ {__html: value || ""} }></div>
}
export const JeppRichTextViewOnList: React.FC<ViewProps<Type.JeppRichText>> = JeppStringViewOnList
export const JeppRichTextViewOnForm: React.FC = (props) => <ReactQuill {...props} theme="snow"/>
// endregion Rich Text

// region URL
export const JeppURLViewOnShow: React.FC<ViewProps<Type.JeppURL>> = ({value}) => {
...
export const JeppURLViewOnList: React.FC<ViewProps<Type.JeppURL>> = ({value}) => {
...
export const CategoryBadge: React.FC<Partial<Type.JeppCategoryInterface>> = (props) => {
    const Link = useLink();
    return <Antd.Popover
    ...
    >
        <Link to={window.environment.appPath + "category/show/:id".replace(":id", String(props.id))}>
            { props.name }
        </Link>
    </Antd.Popover>
}
...
export const ClueBadge: React.FC<Partial<Type.JeppClueInterface>> = (props) => {
    ...
    >
        <Link to={window.environment.appPath + "clue/show/:id".replace(":id", String(props.id))}>
            { props.id }
        </Link>
    </Antd.Popover>
}
...
export const GameBadge: React.FC<Partial<Type.JeppGameInterface>> = (props) => {
    ...
    >
        <Link to={window.environment.appPath + "game/show/:id".replace(":id", String(props.id))}>
            { props.show }
        </Link>
    </Antd.Popover>
}

export const SeasonBadge: React.FC<Partial<Type.JeppSeasonInterface>> = (props) => {
    const Link = useLink();
    return <Antd.Popover
        overlayInnerStyle={ {width: "50vw", height: "40vh", maxHeight:"400px", maxWidth:"500px", overflow: "auto"} }
        content={
    ...
    >
        <Link to={window.environment.appPath + "season/show/:id".replace(":id", String(props.id))}>
            { props.number }
        </Link>
    </Antd.Popover>
}
