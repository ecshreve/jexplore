...
func (cq *CategoryQuery) QueryClues() *ClueQuery {
...
func (cq *CategoryQuery) WithClues(opts ...func(*ClueQuery)) *CategoryQuery {
	query := (&ClueClient{config: cq.config}).Query()
...
func (cq *CategoryQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Category, error) {
	...
	if query := cq.withClues; query != nil {
...
func (cq *CategoryQuery) loadClues(ctx context.Context, query *ClueQuery, nodes []*Category, init func(*Category), assign func(*Category, *Clue)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(clue.FieldCategoryID)
	}
	query.Where(predicate.Clue(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(category.CluesColumn), fks...))
	}))
