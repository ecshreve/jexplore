...
func (cu *ClueUpdate) SetNillableCategoryID(i *int) *ClueUpdate {
	if i != nil {
		cu.SetCategoryID(*i)
	}
	return cu
...
func (cu *ClueUpdate) ClearCategoryID() *ClueUpdate {
...
func (cu *ClueUpdate) SetNillableGameID(i *int) *ClueUpdate {
	if i != nil {
		cu.SetGameID(*i)
	}
	return cu
...
func (cu *ClueUpdate) ClearGameID() *ClueUpdate {
...
// SetNillableCategoryID sets the "category_id" field if the given value is not nil.
func (cuo *ClueUpdateOne) SetNillableCategoryID(i *int) *ClueUpdateOne {
	if i != nil {
		cuo.SetCategoryID(*i)
	}
	return cuo
...
// ClearCategoryID clears the value of the "category_id" field.
func (cuo *ClueUpdateOne) ClearCategoryID() *ClueUpdateOne {
...
// SetNillableGameID sets the "game_id" field if the given value is not nil.
func (cuo *ClueUpdateOne) SetNillableGameID(i *int) *ClueUpdateOne {
	if i != nil {
		cuo.SetGameID(*i)
	}
	return cuo
...
// ClearGameID clears the value of the "game_id" field.
func (cuo *ClueUpdateOne) ClearGameID() *ClueUpdateOne {
