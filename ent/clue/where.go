...
func CategoryIDIsNil() predicate.Clue {
	return predicate.Clue(sql.FieldIsNull(FieldCategoryID))
}

// CategoryIDNotNil applies the NotNil predicate on the "category_id" field.
func CategoryIDNotNil() predicate.Clue {
	return predicate.Clue(sql.FieldNotNull(FieldCategoryID))
}
...
func GameIDIsNil() predicate.Clue {
	return predicate.Clue(sql.FieldIsNull(FieldGameID))
}

// GameIDNotNil applies the NotNil predicate on the "game_id" field.
func GameIDNotNil() predicate.Clue {
	return predicate.Clue(sql.FieldNotNull(FieldGameID))
}
